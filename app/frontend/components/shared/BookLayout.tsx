...
const BookLayout = ({
  ...
  <div className="h-full p-12 flex">
    <div className={twMerge('relative flex-1 h-full my-auto', className)}>
      ...
      <div className="absolute pointer-events-none -left-5 -right-5 top-5 -bottom-5">
      ...
      <div className="absolute pointer-events-none -left-10 -right-10 top-10 -bottom-10">
      ...
      <div className="absolute pointer-events-none -left-15 -right-15 top-15 -bottom-15">
