...
- [x] Be A5 Dimension (5.83 x 8.27 in) – Follow the template [HERE](docs/requirements/fallout-zine)
...
**Grab our template for the zine page [HERE](docs/requirements/fallout-zine)**
